...
[ordered]@{ status='PASS'; control_id='JPV-AUTHORITY-INHERITANCE-001'; claim_truth_consumer='PASS'; disclosure_authorization_lifecycle='PASS'; validated_at_utc=[DateTime]::UtcNow.ToString('o') } | ConvertTo-Json